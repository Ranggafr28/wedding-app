                        ...
                        <div class="flex justify-between">
                            ...
                            <h2 id="accordion-collapse-heading-1">
                                <button type="button"
                                    ...
                                    aria-expanded="{{ !empty($params) || !empty($filterRole) ? 'true' : 'false' }}"
                                    ...
                                    <tr class="bg-gray-100 border-b hover:bg-gray-200 text-gray-900">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            @switch($item->role)
                                                @case('customer')
                                                    <span
                                                        class="bg-blue-100 text-blue-800 border border-blue-600 capitalize text-xs font-medium me-2 px-2.5 py-0.5 rounded">{{ $item->role }}</span>
                                                @break

                                                @case('vendor')
                                                    <span
                                                        class="bg-yellow-100 text-yellow-800 border border-yellow-600 capitalize text-xs font-medium me-2 px-2.5 py-0.5 rounded">{{ $item->role }}</span>
                                                @break

                                                @case('administrator')
                                                    <span
                                                        class="bg-green-100 text-green-800 border border-green-600 capitalize text-xs font-medium me-2 px-2.5 py-0.5 rounded">{{ $item->role }}</span>
                                                @break
                                            @endswitch
                                        </td>
                                        <td class="px-6 py-4 text-center w-32">
                                            <div class="grid grid-cols-2 gap-5">
                                                <a href="{{ route($route . '.edit', [$route => $item->id]) }}"
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route($route . '.destroy', [$route => $item->user_id]) }}"
                                                    method="post">
                                                    @method('delete')
                                                    @csrf
                                                </form>
