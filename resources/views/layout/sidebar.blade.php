<aside
    ...
    <div class="h-19">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700"
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Web Organizer</span>
        </a>
    </div>
        ...
        <ul class="flex flex-col pl-0 mb-10">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ $modul == 'Persetujuan Transaksi' ? 'bg-blue-500/13 rounded-lg font-semibold text-slate-700' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Persetujuan Transaksi</span>
                </a>
            </li>
            <li class="w-full mt-4">
